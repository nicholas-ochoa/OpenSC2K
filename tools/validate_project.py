...
class Project:
    ...
    def configure(self, entry_id):
        ...
        # Headless Godot sleeps 6900 usec after each frame, and tests wait for many frames.
        # A short sleep keeps an idle main loop from taking CPU time from worker threads.
