...
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/moving_foreground_union_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/simulation_debug_window_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/debug_city_tables_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/debug_object_fields_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/about_scene_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/about_music_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/picture_notice_scene_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/scenario_scene_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/player_dialog_scene_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/city_window_scene_test.gd
...
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/settings_scene_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/ui_theme_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/settings_viewport_height_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/dark_underground_shader_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/underground_visibility_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/sidebar_scene_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/workspace_scene_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/status_compass_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/water_shortage_status_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/workspace_overlay_test.gd
...
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/industrial_connection_regression_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/highway_connection_geometry_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/naval_base_regression_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/army_base_regression_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/military_growth_regression_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/eq_decay_regression_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/land_value_isolation_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/data_map_regression_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/utility_capacity_regression_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/original_compatibility_test.gd
...
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/new_city_workflow_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/terrain_layout_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/meandering_terrain_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/terrain_elevation_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/coastal_canyon_test.gd
...
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/network_terrain_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/highway_terrain_route_test.gd
...
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/service_query_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/service_query_ui_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/service_query_mesh_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/trip_reach_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/trip_footprint_test.gd
run_godot godot --audio-driver Dummy --headless --path "$repo_dir/game" --script res://tests/trip_destination_marker_test.gd
