...
func _initialize() -> void:
	...
	var original_city := ProjectSettings.globalize_path("res://../references/CITIES/ISLAND.SC2")
	...
	file.close()
	var again := OriginalCityImporter.import_saved_games(ProjectSettings.globalize_path("res://../references"), saved_root)
	...
	var repeated := OriginalCityImporter.import_saved_games(ProjectSettings.globalize_path("res://../references"), saved_root)
