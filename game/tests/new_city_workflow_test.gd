...
func _run() -> void:
	...
	assert(not main.city_toolbar.view_mode_buttons[CityViewMode.Mode.UNDERGROUND].visible)
	assert(main.city_toolbar.view_mode_buttons[CityViewMode.Mode.HEIGHT].visible)
