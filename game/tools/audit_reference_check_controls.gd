...
func _initialize() -> void:
	...
	assert(FileAccess.get_sha256("res://../references/SIMCITY2000/SIMCITY.EXE") == audit.source_sha256)
	var loaded := PeBitmapResource.load_named_dib("res://../references/SIMCITY2000/SIMCITY.EXE", "CTL3D_3DCHECK")
