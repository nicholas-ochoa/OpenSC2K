...
const LABEL_COUNT := Sc2LabelLayout.ORIGINAL_COUNT
const LABEL_RECORD_SIZE := Sc2LabelLayout.RECORD_SIZE
const MICROSIM_COUNT := Sc2MicrosimLayout.ORIGINAL_COUNT
const MICROSIM_RECORD_SIZE := Sc2MicrosimLayout.RECORD_SIZE
const THING_COUNT := Sc2ThingLayout.ORIGINAL_COUNT
const THING_RECORD_SIZE := Sc2ThingLayout.RECORD_SIZE
const GRAPH_COUNT := Sc2GraphLayout.SERIES_COUNT
