...
const HIGHWAY_STRAIGHT_FIRST := Tiles.HIGHWAY_STRAIGHT_ONE
const HIGHWAY_STRAIGHT_LAST := Tiles.HIGHWAY_POWER_CROSSING_TWO
const BRIDGE_FIRST := Tiles.SUSPENSION_BRIDGE_ONE
