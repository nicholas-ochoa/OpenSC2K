...
static func update_hospital(annual: MicrosimAnnualContext, record_id: int, offset: int) -> void:
	...
	BinaryData.write_u16_be(annual.microsims, offset + 6, _divide_toward_zero(health_funding, 2))
	...
	var hospital_patients: int = (
		_divide_toward_zero(BinaryData.read_u32_be(annual.misc, MISC_NORMAL_POPULATION), hospital_divisor)
	...
	BinaryData.write_u16_be(annual.microsims, offset + 2, hospital_capacity)
	...
	BinaryData.write_u16_be(annual.microsims, offset + 4, hospital_staff)
...
static func update_police_station(annual: MicrosimAnnualContext, record_id: int, offset: int) -> void:
	...
	var crime_per_station := _divide_toward_zero(
		BinaryData.read_u32_be(annual.misc, MISC_CITY_CRIME), police_count
	)
	BinaryData.write_u16_be(annual.microsims, offset + 4, crime_per_station)
	var arrest_divisor := maxi(5 - BinaryData.read_u32_be(annual.misc, MISC_PRISON_BONUS), 1)
	var arrests: int = (
		(annual.random.next_u15() & 0x0f)
		+ _divide_toward_zero(crime_per_station, arrest_divisor)
	)
	BinaryData.write_u16_be(annual.microsims, offset + 6, arrests)
...
static func update_fire_station(annual: MicrosimAnnualContext, record_id: int, offset: int) -> void:
	...
	BinaryData.write_u16_be(annual.microsims, offset + 2, fire_capacity)
	BinaryData.write_u16_be(annual.microsims, offset + 4, ((fire_capacity & 0xffff) >> 4) + 1)
	BinaryData.write_u16_be(annual.microsims, offset + 6, (annual.random.next_u15() % 20) + 2)
...
static func update_school(annual: MicrosimAnnualContext, record_id: int, offset: int) -> void:
	...
	BinaryData.write_u16_be(annual.microsims, offset + 6, school_funding_quarter)
	...
	BinaryData.write_u16_be(annual.microsims, offset + 2, school_capacity)
	...
	BinaryData.write_u16_be(annual.microsims, offset + 4, school_staff)
...
static func update_prison(annual: MicrosimAnnualContext, record_id: int, offset: int) -> void:
	...
	var prisoners := (
		BinaryData.read_u16_be(annual.microsims, offset + 2)
		- _divide_toward_zero(BinaryData.read_u16_be(annual.microsims, offset + 2), 4)
		+ _divide_toward_zero(BinaryData.read_u32_be(annual.misc, MISC_OLD_ARRESTS), prison_divisor)
	)
	...
	BinaryData.write_u16_be(annual.microsims, offset + 6, prison_stat)
...
static func update_college(annual: MicrosimAnnualContext, record_id: int, offset: int) -> void:
	...
	BinaryData.write_u16_be(annual.microsims, offset + 6, college_funding)
	...
	BinaryData.write_u16_be(annual.microsims, offset + 2, college_capacity)
	...
	BinaryData.write_u16_be(annual.microsims, offset + 4, college_staff)
