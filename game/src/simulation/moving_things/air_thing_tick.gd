...
static func _convert_to_explosion(
	...
	AirThingMotion._convert_to_explosion(things, record, state, goal)
...
static func _move_thing_eight_way(
	...
	return AirThingMotion._move_thing_eight_way(thing_type, text, things, record, direction, map_edge)
...
static func _air_route_blocked(
	...
	return AirThingMotion._air_route_blocked(buildings, current, direction, map_edge)
