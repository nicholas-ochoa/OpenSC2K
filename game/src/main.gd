...
func _build_interface(toolbar_art: Image) -> void:
	...
	var implemented_disasters := {
		...
		10: true, 11: true, 13: true, 15: true,
	}
	...
	disasters_menu.tooltip_text = (
		"Fire, Flood, Riot, Toxic Spill, Earthquake, Tornado, Monster, Meltdown, Microwave, Volcano, Mass Riots, and Pollution are available."
	)
