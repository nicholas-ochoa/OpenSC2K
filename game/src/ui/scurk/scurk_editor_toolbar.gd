...
func build() -> void:
	...
	for action in ["RecoverProject", "ExportTileSet", "PaintOptions", "ReplaceColor", "SelectAll", "Deselect", "CopySelection", "CutSelection", "DuplicateSelection", "DeleteSelection", "PasteSelection", "CopyAllLayers", "CutAllLayers", "PasteNewLayer"]:
